...
const CHANNEL_FRAMING: Record<CustomerAgentChannel, string> = {
  ...
  voice: [
    ...
    '',
    '**Hard cap: 3 assistant turns from the first "agent" trigger to the closing sentence.** If you find yourself on Turn 4 without firing a tool, fire `flag_for_office_review` immediately with whatever info you have and close.',
    '',
