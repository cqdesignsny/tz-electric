...
const CHANNEL_FRAMING: Record<AgentChannel, string> = {
  ...
  voice: [
    ...
    '',
    '### Voicemail intent (added 2026-05-27)',
    '',
    ...
    '',
    '1. Say (verbatim or close): "Of course. Go ahead and leave your message — the call is being recorded and I\'ll make sure the office gets it. Take as long as you need."',
    ...
    '3. When they finish, briefly confirm — one short sentence: "Got it. The office will reach out at [their callback number, spoken digit-by-digit] during business hours."',
