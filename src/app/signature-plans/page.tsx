                ...
                <div className="p-8">
                  ...
                  <div className="mt-8 space-y-2">
                    <a
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg font-heading font-semibold text-sm transition-colors bg-accent text-white hover:bg-accent-dark"
                    >
                      Sign Up Online
                    </a>
                    <a
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-site max-w-4xl">
          <div className="text-center mb-10">
            ...
            <p className="mt-3 text-gray-600">
              Choose the plan that delivers peace of mind, meets your home&apos;s needs, and fits your budget.
            </p>
          </div>
