...
export const metadata = createMetadata({
  title: 'Welcome to Your TZ Signature Plan | TZ Electric',
  description: 'Your TZ Signature Plan enrollment is confirmed. We will be in touch shortly to schedule your first assessment.',
  path: '/signature-plans/success',
})

export default function SignaturePlansSuccessPage() {
  return (
    <section className="section-padding bg-gray-50">
      <div className="container-site max-w-2xl text-center">
        ...
        <h1 className="text-navy text-3xl lg:text-4xl font-heading font-bold">
          Welcome to the TZ Signature Plan!
        </h1>

        <p className="mt-4 text-gray-600 text-lg leading-relaxed">
          Your payment has been processed successfully. Our team will be in touch
          shortly to schedule your first assessment and get you set up.
        </p>
        ...
        <div className="mt-4 bg-white rounded-2xl border-2 border-blue/15 p-6 text-left">
          ...
          <ul className="space-y-3">
            {[
              ...
              'Our team will contact you to schedule your first assessment.',
              'Enjoy priority scheduling, exclusive discounts, and peace of mind.',
            ].map((step, i) => (
