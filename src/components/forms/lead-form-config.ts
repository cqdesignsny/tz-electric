...
export const SERVICES: ServiceConfig[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        showWhen: { when: 'heatingOrCooling', equals: ['Both heating and cooling'] },
      },
      {
        id: 'scopeCooling',
        label: 'Cooling one room or multiple rooms?',
        type: 'select',
        required: true,
        options: [
          'One room',
        ...
        showWhen: { when: 'heatingOrCooling', equals: ['Cooling only'] },
      },
      {
        id: 'scopeHeating',
        label: 'Heating one room or multiple rooms?',
        type: 'select',
        required: true,
        options: [
          'One room',
        ...
        showWhen: { when: 'heatingOrCooling', equals: ['Heating only'] },
      },
      {
        id: 'coverage',
