...
export default function SubServicePageTemplate({ service }: SubServicePageTemplateProps) {
  ...
  return (
    <>
        ...
        <div className="container-site relative z-10 py-16 lg:py-24">
          <div className="max-w-3xl">
            ...
            <nav className="mb-5 flex items-center gap-2 text-sm text-gray-400">
              <Link href={`/${service.parent}`} className="hover:text-white transition-colors">
                {service.parentTitle}
              </Link>
        ...
        <section className="section-padding bg-navy">
          <div className="container-site">
            <div className="text-center mb-12">
              ...
              <h2 className="font-heading font-bold text-white mt-2 text-3xl lg:text-4xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {service.process.map((step, i) => (
                <div key={i} className="relative bg-white/5 border border-white/10 rounded-2xl p-7 hover:bg-white/10 hover:border-blue/40 transition-all duration-300">
                  <div className="w-12 h-12 rounded-xl bg-blue flex items-center justify-center text-white font-heading font-bold text-xl mb-5">
                    {step.step}
                  </div>
      ...
      <section className={`section-padding ${service.process && service.process.length > 0 ? '' : 'bg-off-white'}`}>
        <div className="container-site">
          <SectionHeader
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {service.features.map((feature) => (
              <div
                key={feature.title}
                className="relative bg-white rounded-2xl border-2 border-blue/20 p-7 pt-8 shadow-sm hover:shadow-lg hover:border-blue/50 hover:-translate-y-1 transition-all duration-300 group overflow-hidden"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-4 text-gray-600 leading-relaxed text-lg">
                ...
                Every job includes upfront pricing, professional licensed technicians, and our
          ...
          <div className="space-y-4">
            {service.faqs.map((faq) => (
              ...
              >
                ...
                <div className="px-6 pb-5 text-gray-600 leading-relaxed border-t border-blue/10 pt-4 ml-11">
                  {faq.answer}
                </div>
              </details>
            ))}
