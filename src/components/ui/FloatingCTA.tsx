  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-end">
      ...
      <a
        ...
        className="flex items-center gap-2 bg-blue text-white px-5 py-3 rounded-full shadow-lg hover:bg-blue-dark transition-all duration-300 hover:scale-105 font-heading font-semibold text-sm"
      >
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
