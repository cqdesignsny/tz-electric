...
export default function Footer() {
  ...
  return (
    <footer className="bg-navy text-white">
      {/* CTA Banner — compact on mobile, more presence on desktop */}
      <div className="bg-gradient-to-r from-navy-light to-navy">
        <div className="container-site py-6 md:py-8 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 md:gap-3">
            ...
            <Button href={QUOTE_URL} size="sm" className="md:!px-7 md:!py-3 md:!text-base">
              Get a Free Quote
            </Button>
          </div>
        </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3 justify-center md:justify-start">
              <a
                ...
                className="w-9 h-9 bg-navy-light rounded-lg flex items-center justify-center text-gray-400 hover:text-white hover:bg-blue transition-colors"
                aria-label="Facebook"
              >
              ...
              <a
                href={COMPANY.social.nextdoor}
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 bg-navy-light rounded-lg flex items-center justify-center text-gray-400 hover:text-white hover:bg-green-600 transition-colors"
                aria-label="Nextdoor"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex justify-between">
                <span>Mon - Fri</span>
                <span className="text-white">{COMPANY.hours.weekday}</span>
              </li>
              <li className="flex justify-between">
                <span>Saturday</span>
                <span className="text-white">{COMPANY.hours.saturday}</span>
              </li>
              <li className="flex justify-between">
                <span>Sunday</span>
