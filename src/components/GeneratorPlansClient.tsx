...
interface GeneratorPlansClientProps {
...
export default function GeneratorPlansClient({ plans }: GeneratorPlansClientProps) {
  const [selectedPlan, setSelectedPlan] = useState<MaintenancePlan | null>(null)
  const [isModalOpen, setIsModalOpen] = useState(false)

  function handleSignUp(plan: MaintenancePlan) {
  ...
  return (
    <>
      ...
      <SignupModal
        ...
        plan={selectedPlan}
        title="GENERATOR MAINTENANCE PLAN"
