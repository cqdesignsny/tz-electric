...
## Remaining
- [ ] **Native forms to replace Typeform (priority)** — Build multi-step lead capture form and job application form directly on the site, wired to Housecall Pro CRM. Eliminates Typeform subscription, improves ad conversion tracking, and sends leads directly to HCP. Two forms: lead form (Get a Free Quote) and career application form.
