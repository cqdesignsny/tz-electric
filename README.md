...
9. **SMS Claire model wire-up.** Replace the TODO block in `src/app/api/agents/sms/webhook/route.ts` with a `generateText({...})` call once A2P 10DLC carrier review clears (Cesar kicked off the registration 2026-05-26). ~30 min of code.
