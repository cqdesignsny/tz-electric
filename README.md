...
| Anthropic (direct, via Vapi) | Live | Claude Sonnet 4.6 behind Voice Claire (swapped from Haiku 4.5 in session 29, after Haiku could not assemble the `create_lead` payload and voice was booking 0 leads). Model fees billed by Vapi. |
